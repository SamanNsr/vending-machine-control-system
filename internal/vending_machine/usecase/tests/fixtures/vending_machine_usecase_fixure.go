...
var (
	...
	VM4 = vendingMachineDomain.VendingMachine{ID: 4, Status: vendingMachineConstants.StatusSelecting, Inventory: &vendingMachineDomain.Inventory{Cola: 0, Coffee: 8}, Coins: 0, LastAccess: time.Now()}
	VM5 = vendingMachineDomain.VendingMachine{ID: 5, Status: vendingMachineConstants.StatusSelecting, Inventory: &vendingMachineDomain.Inventory{Cola: 2, Coffee: 0}, Coins: 0, LastAccess: time.Now()}
	VM6 = vendingMachineDomain.VendingMachine{ID: 6, Status: vendingMachineConstants.StatusSelecting, Inventory: &vendingMachineDomain.Inventory{Cola: 0, Coffee: 0}, Coins: 0, LastAccess: time.Now()}
)
